...
\restrict 15A7mzsZJICyqlXuLmAyTUaU0fHxH60faC57mDC1dU4zhiPp0s6pDEAZiTNKEqc
...
ALTER TABLE IF EXISTS ONLY public.p_characters DROP CONSTRAINT IF EXISTS p_characters_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.p_characters DROP CONSTRAINT IF EXISTS p_characters_job_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.p_users DROP CONSTRAINT IF EXISTS p_users_pkey;
ALTER TABLE IF EXISTS ONLY public.p_jobs DROP CONSTRAINT IF EXISTS p_jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.p_characters DROP CONSTRAINT IF EXISTS p_characters_pkey;
...
DROP TABLE IF EXISTS public.p_users;
DROP TABLE IF EXISTS public.p_jobs;
DROP TABLE IF EXISTS public.p_characters;
...
\unrestrict 15A7mzsZJICyqlXuLmAyTUaU0fHxH60faC57mDC1dU4zhiPp0s6pDEAZiTNKEqc
